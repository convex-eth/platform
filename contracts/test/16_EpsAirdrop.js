...
var droplist = jsonfile.readFileSync('../airdrop/eps/2022_01_20/drop_proofs.json');
...
contract("Airdrop Test", async accounts => {
  it("should claim airdrop for all users", async () => {
    ...
    let airdrop = await MerkleAirdrop.at("0xF776ad79740115B826Ec4BcF3641329852625399");//week 35
